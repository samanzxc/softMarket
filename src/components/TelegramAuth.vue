...
const loadTelegramWidget = () => {
  return new Promise((resolve, reject) => {
    ...
    script.setAttribute('data-telegram-login', 'testingappit_bot') // Твой бот
...
const handleTelegramAuth = async (telegramData) => {
  ...
  try {
    ...
    notify('Ошибка при входе через Telegram. Попробуйте еще раз.', 'error')
  } finally {
  ...
  <div class="telegram-auth">
    <div class="telegram-auth-container">
      ...
      <div class="telegram-widget-container">
        ...
        <div v-else-if="telegramWidgetLoaded" class="telegram-widget">
